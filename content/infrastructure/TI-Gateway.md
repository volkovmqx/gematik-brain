...
Das TI-Gateway unterstützt bestehende Primärsystem-Schnittstellen (SOAP-Webservices), die auch der Konnektor verwendet. So können Praxisverwaltungssysteme (PVS), Krankenhausin-formationssysteme (KIS) und Apothekenverwaltungssysteme (AVS) ohne vollständige Neuimplementierung auf das TI-Gateway umsteigen.
