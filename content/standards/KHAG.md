---
title: KHAG - Krankenhausreformanpassungsgesetz
audience: [technical, non-technical]
tags: [standards, gesetzgebung, krankenhaus, interoperabilität, reform]
aliases: [Krankenhausreformanpassungsgesetz, KHAG]
relevance:
...
**Interoperabilitätsstandards**: Verbindliche Mindestanforderungen für die IT-Interoperabilität von Krankenhäusern müssen bis **September 2026** definiert werden. Diese werden im [[Interoperabilitaetsverzeichnis|Interoperabilitätsverzeichnis]] (§ 385 SGB V) verankert.

> [!frist-warnung] Frist-Warnung: Patientenportal-Abschlag seit 1. Januar 2026
...
### Abgrenzung zu anderen Krankenhausgesetzen
...
Das KHAG verpflichtet Krankenhäuser zur Umsetzung verbindlicher Interoperabilitätsstandards. Diese werden konkret im [[Interoperabilitaetsverzeichnis|Interoperabilitätsverzeichnis der gematik (§ 385 SGB V)]] verankert. Für den Krankenhausbereich ist vor allem [[ISiK]] (Informationstechnische Systeme in Krankenhäusern) relevant:
...
> [!frist-warnung] Frist-Warnung: ISiK Stufe 3 Pflicht bis 30. Juni 2026
...
> [!klinik-integration] Klinik-Integration: KHAG-Pflichten für die IT-Abteilung
...
> [!dev-quickstart] Dev Quickstart: ISiK Stufe 3 FHIR REST-Konformitätsprüfung
> ```bash
> # ISiK Basismodul: Patienten-Ressource abrufen (Pflichtendpunkt)
> GET https://<KIS-FHIR-Endpoint>/Patient?identifier=<IKNR-oder-Patientennummer>
> Accept: application/fhir+json
>
> # ISiK Modul Dokumentenaustausch: DocumentReference suchen
> GET https://<KIS-FHIR-Endpoint>/DocumentReference?patient=<patient-id>&status=current
> Accept: application/fhir+json
>
> # ISiK Modul Medikation: MedicationStatement abfragen
> GET https://<KIS-FHIR-Endpoint>/MedicationStatement?subject=<patient-id>
> Accept: application/fhir+json
> ```
...
> - Conformance-Test: [gematik/isik3-testsuite](https://github.com/gematik/isik3-testsuite)
>
> IG: [ISiK-Basismodul Stufe 3](https://gematik.github.io/spec-ISiK-Basismodul/IG/3.0.0/) | GitHub: [gematik/spec-ISiK-Basismodul](https://github.com/gematik/spec-ISiK-Basismodul)
...
Das KHAG knüpft den Abschlag an das Fehlen eines zertifizierten [[Patientenportal|Patientenportals]]. Die gematik definiert, welche Funktionen ein Patientenportal für die Zertifizierung erfüllen muss. Typischerweise umfasst das:

- Digitale Terminbuchung
- Digitale Aufnahme und Anamnese
- Zugang zu Befunden und Entlassberichten
- Möglichkeit zur Datenübermittlung an die [[ePA]]

### Telemedizin-Netzwerke

Das KHAG fördert telemedizinische Verbundlösungen zwischen Krankenhäusern. Konkret werden Netzwerke unterstützt, in denen spezialisierte Zentren kleinere Häuser bei der Versorgung komplexer Fälle (z.B. Schlaganfall, Intensivmedizin) telemedizinisch unterstützen. Technische Grundlage sind [[TI-Messenger]], [[Videosprechstunde|Videokonsultationssysteme]] und FHIR-basierter Dokumentenaustausch.
...
- [[KIS]] (muss KHAG-Anforderungen erfüllen)
- [[Patientenportal]] (ohne zertifiziertes Portal: Abschlag 0,5 % je Fall)
- [[Interoperabilitaetsverzeichnis]] (gematik verankert KHAG-Standards hier)
- [[gematik]] (definiert Zertifizierungsanforderungen für Patientenportale)
- [[Telematikinfrastruktur]] (TI-Anbindung als Voraussetzung für Interoperabilität)
- [[ePA]] (Krankenhäuser müssen ePA-Modul im KIS haben, ab April 2026 Pflicht)
- [[DRG]] (Abrechnungssystem, in das der Patientenportal-Abschlag eingreift)
